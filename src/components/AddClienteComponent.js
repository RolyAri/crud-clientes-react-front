...
export const AddClienteComponent = () => {
    ...
    const title = () =>{
        if(id){
            ...
            return <h2 className='text-center'>Agregar Clientes</h2>
        }
    }
    return (
        <div>
                        ...
                        <div className='card-body'>
                            <form>
                                ...
                                <div className='form-group mb-2'>
                                    ...
                                    <input type='text' placeholder='Digite su email' name='email' className='form-control' value={email} onChange={(e) => setEmail(e.target.value)}></input>
                                </div>
